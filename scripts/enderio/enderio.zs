...
//Fluid Conduit
assembler.recipeBuilder()
    .inputs([<ore:pipeSmallFluidSteel>, <ore:plateDarkSteel>,<enderio:item_material:4>*2])
    .fluidInputs(<liquid:plastic> * 144)
...
//Fluid Conduit
assembler.recipeBuilder()
    .inputs([<ore:pipeSmallFluidPolytetrafluoroethylene>, <ore:plateVibrantAlloy>,<enderio:item_material:4>*2])
    .fluidInputs(<liquid:plastic> * 144)
