...
val plateDesh = <ore:plateDesh>;
plateDesh.remove(<galacticraftplanets:item_basic_mars:5>);
...
assembler.recipeBuilder()
    .inputs(<gregtech:meta_item_1:291>*3,<gregtech:meta_item_1:81> )
...
assembler.recipeBuilder()
    .inputs(<gregtech:meta_wire_fine:25014>*16,<ore:foilSilver>*16)
    .fluidInputs(<liquid:epoxy>*576)
    .outputs(<gregtech:optical_pipe_normal>)
    .duration(30)
    .EUt(120)
    .buildAndRegister();
