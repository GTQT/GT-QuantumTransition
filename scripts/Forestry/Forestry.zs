...
recipes.addShaped(<forestry:engine_peat>, 
	...
	[<ore:circuitLv>, <ore:craftingPiston>, <ore:circuitLv>], 
...
assembler.recipeBuilder()
	.inputs([<forestry:alveary.plain>, <forestry:thermionic_tubes:7> *4, <ore:plateSteel>, <gregtech:machine:380> *3, motorMv])
...
assembler.recipeBuilder()
	.inputs([<forestry:alveary.plain>, <forestry:thermionic_tubes:6> *4, <ore:circuitLv>, <gregtech:machine:380> *2, <ore:plateRedAlloy>, <gregtech:fluid_pipe_large:1012>])
...
assembler.recipeBuilder()
	.inputs([<forestry:alveary.plain>, <forestry:thermionic_tubes:4> *4, <forestry:portable_alyzer>, <gregtech:meta_stick:288> *4, <ore:plateCertusQuartz> *2])
