...
assembler.recipeBuilder()
    .inputs(<plustic:laser_medium>.withTag({Material: "prismarine"}),<gregtech:meta_item_1:748>*4,<gregtech:wire_single:427>*12)
    .fluidInputs(<liquid:silicone_rubber> * 144)
    .circuit(1)
    .outputs(<galacticraftplanets:item_basic_asteroids:8>)
    .duration(300)
    .EUt(480)
    .buildAndRegister();
...
implosion_compressor.recipeBuilder()
    .inputs(<ore:plateMeteoricIron>*9)
    .property("explosives", <minecraft:tnt> * 2)
...
recipes.addShaped(<galacticraftcore:sensor_lens>, [[<ore:ringRedAlloy>, <ore:lensDiamond>, <ore:ringRedAlloy>],[<ore:circuitHv>, <gregtech:meta_lens:276>, <ore:circuitHv>], [<ore:screwStainlessSteel>, <ore:gtceScrewdrivers>, <ore:screwStainlessSteel>]]);
