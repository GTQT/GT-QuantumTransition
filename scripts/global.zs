...
<ore:toolJuicer>.addItems([
	<gregtech:mallet>.withEmptyTag()]);

<ore:toolCuttingboard>.addItems([
	<gregtech:butchery_knife>.withEmptyTag()]);

<ore:toolMortarandpestle>.addItems([
	<gregtech:mortar>.withEmptyTag()]);

<ore:toolBakeware>.addItems([
	<gregtechfoodoption:rolling_pin>.withEmptyTag()]);
	
<ore:listAllRingRubber>.addItems([
	<gregtech:meta_ring:1004>, <gregtech:meta_ring:1068>, <gregtech:meta_ring:1000>]);

<ore:listAllPlateRubber>.addItems([
	<gregtech:meta_plate:1068>, <gregtech:meta_plate:1004>, <gregtech:meta_plate:1000>]);

assembler.recipeBuilder()
	.inputs([<enderio:item_basic_capacitor> * 2, <gregtech:meta_dust:271>])
