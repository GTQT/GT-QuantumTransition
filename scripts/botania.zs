...
mods.botania.Orechid.addOre(<ore:oreAluminium>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBeryllium>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCobalt>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCopper>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGold>, 5000000);
mods.botania.Orechid.addOre(<ore:oreIron>, 5000000);
mods.botania.Orechid.addOre(<ore:oreLead>, 5000000);
mods.botania.Orechid.addOre(<ore:oreLithium>, 5000000);
mods.botania.Orechid.addOre(<ore:oreMolybdenum>, 5000000);
mods.botania.Orechid.addOre(<ore:oreNeodymium>, 5000000);
mods.botania.Orechid.addOre(<ore:oreNickel>, 5000000);
mods.botania.Orechid.addOre(<ore:orePalladium>, 5000000);
mods.botania.Orechid.addOre(<ore:orePlatinum>, 5000000);
mods.botania.Orechid.addOre(<ore:orePlutonium>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSilver>, 5000000);
...
mods.botania.Orechid.addOre(<ore:oreBanded_Iron>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBlue_Topaz>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBrown_Limonite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCalcite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCassiterite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCassiterite_Sand>, 5000000);
mods.botania.Orechid.addOre(<ore:oreChalcopyrite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreChromite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCinnabar>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCoal>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCobaltite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreCooperite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreDiamond>, 5000000);
mods.botania.Orechid.addOre(<ore:oreEmerald>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGalena>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGarnierite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGreen_Sapphire>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGrossular>, 5000000);
mods.botania.Orechid.addOre(<ore:oreIlmenite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBauxite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreLazurite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreMagnesite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreMagnetite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreMolybdenite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePowellite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePyrite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePyrolusite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePyrope>, 5000000);
mods.botania.Orechid.addOre(<ore:oreRock_Salt>, 5000000);
mods.botania.Orechid.addOre(<ore:oreRuby>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSalt>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSaltpeter>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSapphire>, 5000000);
mods.botania.Orechid.addOre(<ore:oreScheelite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSodalite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreTantalite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSpessartine>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSphalerite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreStibnite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreTetrahedrite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreUraninite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreTopaz>, 5000000);
mods.botania.Orechid.addOre(<ore:oreTungstate>, 5000000);
mods.botania.Orechid.addOre(<ore:oreWulfenite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreYellow_Limonite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreNether_Quartz>, 5000000);
mods.botania.Orechid.addOre(<ore:oreQuartzite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGraphite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBornite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreChalcocite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreRealgar>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBastnasite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePentlandite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreLepidolite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGlauconite_Sand>, 5000000);
mods.botania.Orechid.addOre(<ore:oreMalachite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreMica>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBarite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreAlunite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreTalc>, 5000000);
mods.botania.Orechid.addOre(<ore:oreSoapstone>, 5000000);
mods.botania.Orechid.addOre(<ore:oreKyanite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePyrochlore>, 5000000);
mods.botania.Orechid.addOre(<ore:oreOilsands>, 5000000);
mods.botania.Orechid.addOre(<ore:oreOlivine>, 5000000);
mods.botania.Orechid.addOre(<ore:oreOpal>, 5000000);
mods.botania.Orechid.addOre(<ore:oreAmethyst>, 5000000);
mods.botania.Orechid.addOre(<ore:oreLapis>, 5000000);
mods.botania.Orechid.addOre(<ore:oreApatite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreTricalcium_Phosphate>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGarnet_Red>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGarnet_Yellow>, 5000000);
mods.botania.Orechid.addOre(<ore:oreVanadium_Magnetite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePollucite>, 5000000);
mods.botania.Orechid.addOre(<ore:orePitchblende>, 5000000);
mods.botania.Orechid.addOre(<ore:oreMonazite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBentonite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreFullers_Earth>, 5000000);
mods.botania.Orechid.addOre(<ore:oreZeolite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreRedstone>, 5000000);
mods.botania.Orechid.addOre(<ore:oreTrona>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGypsum>, 5000000);
mods.botania.Orechid.addOre(<ore:oreElectrotine>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGranitic_Mineral_Sand>, 5000000);
mods.botania.Orechid.addOre(<ore:oreGarnet_Sand>, 5000000);
mods.botania.Orechid.addOre(<ore:oreDiatomite>, 5000000);
mods.botania.Orechid.addOre(<ore:oreBasaltic_Mineral_Sand>, 5000000);
...
recipes.addShapeless(<gregtech:meta_ingot:32043>, [<botania:manaresource>]);
//recipes.addShapeless(<metaitem:blockLivingrock>, [<botania:storage>]);
ManaInfusion.addInfusion(<gregtech:meta_dust:32043>, <ore:dustSteel>, 3000);
...
ManaInfusion.addInfusion(<botania:manaresource:2>,<gregtech:meta_lens:276>,20000);
...
centrifuge.recipeBuilder()
    ...
    .chancedOutput(<gregtech:meta_item_1:499>, 1000, 1000)
    .duration(100)
    .EUt(10)
    .buildAndRegister();
...
Apothecary.addRecipe(<botania:specialflower>.withTag({type: "puredaisy"}), [
    ...
    <ebwizardry:magic_crystal>, <gregtech:meta_item_1:127>]);
...
PureDaisy.addRecipe(<minecraft:stone>, <metaitem:blockLivingrock>, 30);

//熔融活石
//Melting.removeRecipe(<liquid:livingrock>, <botania:livingrock>);
Melting.addRecipe(<liquid:livingrock> * 144,<metaitem:blockLivingrock>, 600);
...
macerator.recipeBuilder()
    ...
    .outputs(<gregtech:meta_dust:32049>)
    .chancedOutput(<gregtech:meta_dust:32049> * 2, 100, 1000)
    .duration(100)
    .EUt(12)
    .buildAndRegister();
...
ArcaneWorkbench.registerShapedRecipe("pool", "", 20, [<aspect:aer>, <aspect:ordo>, <aspect:terra>],
    <botania:altar>, [
        ...
        [<ore:screwStainlessSteel>, <ore:ingotThaumium>, <ore:screwStainlessSteel>],
...
Apothecary.addRecipe(<botania:specialflower>.withTag({type: "endoflame"}),
    ...
    <ore:petalRed>, <ebwizardry:magic_crystal>, <gregtech:meta_dust:32049>]);

//符文祭坛
ArcaneWorkbench.registerShapedRecipe("runealtar", "", 20, [<aspect:aer>, <aspect:ordo>, <aspect:terra>, <aspect:ignis>],
    <botania:runealtar>, [
        [<gregtech:meta_stick:32049>, <gregtech:meta_plate:32049>, <gregtech:meta_stick:32049>],
        [<gregtech:meta_plate:32049>, <ore:blockLivingrock>, <gregtech:meta_plate:32049>],
        [<ore:manaDiamond>, <gregtech:meta_plate:32049>, <enderio:block_tank:1>]
]);
...
RuneAltar.addRecipe(<botania:rune:1> * 2, [
    ...
    <minecraft:magma_cream>, <gregtech:meta_lens:311>
], 10000);
# 地之符文
...
Agglomeration.addRecipe(<botania:manaresource:4>,
    [<ore:ingotManasteel>, <ore:ingotThaumium>, <minecraft:diamond>, <ore:ingotStainlessSteel>], 200000);
...
chemical_reactor.recipeBuilder()
    .fluidInputs([<liquid:biomass>*1000,<liquid:fluidedmana>*1000])
