...
electric_blast_furnace.recipeBuilder() 
    ...
    .outputs(<gregtech:meta_ingot_hot:99> * 1) 
	.circuit(1) 
...
/*	
electric_blast_furnace.recipeBuilder() 
    .inputs(<gregtech:meta_block_compressed_6:3>*16,<gregtech:meta_dust_small:351> * 1)
    .fluidInputs(<liquid:nitrogen> * 1000) 
...
electric_blast_furnace.recipeBuilder() 
    .inputs(<gregtech:meta_dust:2>,<gregtech:meta_dust:32035>*2,<gregtech:meta_dust:18>*1)
...
electric_blast_furnace.recipeBuilder() 
    .fluidInputs(<liquid:liusuangaoha>*1000)
    .outputs(<gregtech:meta_dust:32349>) 
...
electric_blast_furnace.recipeBuilder() 
    .inputs(<gregtech:meta_dust:32350>,<gregtech:meta_dust:59>*2)
    .outputs(<gregtech:meta_dust:32367>,<gregtech:meta_dust:357>*6) 
    .property("temperature", 3700)
    .duration(900)
    .EUt(1920)
    .buildAndRegister();
...
electric_blast_furnace.recipeBuilder() 
    .inputs(<gregtech:meta_dust:32351>,<gregtech:meta_dust:59>*2)
...
electric_blast_furnace.recipeBuilder() 
    .inputs(<gregtech:meta_dust:32352>,<gregtech:meta_dust:59>*2)
...
electric_blast_furnace.recipeBuilder() 
	.fluidInputs(<liquid:oxygen>*1000)
	.inputs(<minecraft:iron_ingot>*4,<gregtech:meta_dust:18>)
...
electric_blast_furnace.recipeBuilder() 
	.fluidInputs(<liquid:plasma.argon>*2880)
	.inputs(<ore:gemLapotron>)
	.outputs(<extraplanets:tier7_items:5>)
