...
assembler.recipeBuilder() 
    .inputs(<galacticraftcore:item_basic_moon:1>,<galaxyspace:compressed_plates:1>,<galaxyspace:compressed_plates:2>)
    .outputs(<gtqtcore:gtqt_meta_item_1:343>)
    .duration(20)
    .EUt(120)
    .buildAndRegister();
	
assembler.recipeBuilder() 
    .inputs(<galacticraftplanets:item_basic_mars:5>,<galacticraftplanets:item_basic_asteroids:6>,<galaxyspace:compressed_plates:3>)
    .outputs(<gtqtcore:gtqt_meta_item_1:344>)
    .duration(20)
    .EUt(120)
    .buildAndRegister();
...
<gtqtcore:gtqt_meta_item_1:343>,
<gtqtcore:gtqt_meta_item_1:344>,
<gtqtcore:gtqt_meta_item_1:345>,
<gtqtcore:gtqt_meta_item_1:346>,
<gtqtcore:gtqt_meta_item_1:347>,
