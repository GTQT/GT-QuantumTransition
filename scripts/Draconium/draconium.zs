...
assembly_line.recipeBuilder()
    .inputs([
		...
		<gregtech:meta_stick_long:32099>*2
    ])
    .outputs(<draconicevolution:draconic_core>)
    .fluidInputs([<liquid:soldering_alloy> * 864,<liquid:polybenzimidazole> * 144,<liquid:molten_blood_infused_iron>*576])
    .EUt(131072)
    .duration(500)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    .inputs([
        ...
        <gregtech:meta_item_1:708> * 1,
		<gregtech:meta_stick_long:32099>*4
    ])
    .outputs(<draconicevolution:wyvern_core>)
    .fluidInputs([<liquid:soldering_alloy> * 1440,<liquid:polybenzimidazole> * 288,<liquid:molten_blood_infused_iron>*576])
    .EUt(524288)
    .duration(650)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    .inputs([
		...
		<gregtech:meta_stick_long:32099>*2*8
    ])
...
assembly_line.recipeBuilder()
    .inputs([
		...
		<gregtech:meta_stick_long:32099>*2*16
    ])
...
assembly_line.recipeBuilder()
    ...
    .fluidInputs([
        ...
        <liquid:star_inside_material> * 1280,
		<liquid:molten.ruthenium_trinium_americium_neutronate>*2016,
		<liquid:uu_matter>*8000
    ])
    .EUt(32768)
    .duration(600)
    .buildAndRegister();
...
//混沌能量核心
assembly_line.recipeBuilder()
    .inputs([<draconicevolution:draconic_energy_core> * 4,<draconicevolution:chaos_shard>,<gregtech:meta_item_1:581> * 24,<gregtech:meta_item_1:752>,<contenttweaker:nanites>*16,
