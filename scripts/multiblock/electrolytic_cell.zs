...
electrolytic_cell.recipeBuilder() 
    .notConsumable(<gregtech:meta_stick_long:80>*16)
	.inputs(<metaitem:dustCooperite> * 6)
	.fluidInputs(<liquid:hydrochloric_acid>*6000)
    .fluidOutputs(<liquid:hydrogen>*6000)
	.chancedOutput(<gregtech:meta_dust:299> * 2, 6000, 500)
	.chancedOutput(<gregtech:meta_dust:299> * 2, 4000, 500)
	.chancedOutput(<gregtech:meta_dust:69>, 6000, 500)
	.chancedOutput(<gregtech:meta_dust:2058>, 6000, 500)
	.chancedOutput(<gregtech:meta_dust:103>, 6000, 500)
	.chancedOutput(<gregtech:meta_dust:2057> , 6000, 500)
	.circuit(1)
	.EUt(2048)
    .duration(1200) 
    .buildAndRegister(); 