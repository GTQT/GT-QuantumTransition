mods.gregtech.gantry_crane.recipeBuilder()
...
mods.gregtech.gantry_crane.recipeBuilder()
    ...
    .duration(20000) // 10 seconds
    .EUt(1960) // HV recipe
	.notConsumable(item('galacticraftcore:schematic', 1))
    .buildAndRegister()
...
mods.gregtech.gantry_crane.recipeBuilder()
    ...
    .duration(20000) // 10 seconds
    .EUt(7680) // HV recipe
	.notConsumable(item('galaxyspace:rocket_modules', 8))
    .buildAndRegister()
...
mods.gregtech.gantry_crane.recipeBuilder()
    ...
    .duration(20000) // 10 seconds
    .EUt(7680) // HV recipe
	.notConsumable(item('galaxyspace:rocket_modules', 9))
    .buildAndRegister()
...
mods.gregtech.gantry_crane.recipeBuilder()
    ...
    .duration(20000) // 10 seconds
    .EUt(7680) // HV recipe
	.notConsumable(item('galaxyspace:rocket_modules', 10))
    .buildAndRegister()
...
mods.gregtech.assembler.recipeBuilder()
    ...
    .duration(200) 
    .EUt(480) 
	.notConsumable(item('galaxyspace:schematics', 4))
    .buildAndRegister()
//助推器
mods.gregtech.assembler.recipeBuilder()
...
mods.gregtech.assembler.recipeBuilder()
    ...
    .duration(20000) 
    .EUt(7680) 
	.notConsumable(item('galaxyspace:schematics'))
    .buildAndRegister()
//
mods.gregtech.assembler.recipeBuilder()
    ...
    .duration(20000) 
    .EUt(7680) 
	.notConsumable(item('galaxyspace:schematics', 1))
    .buildAndRegister()
//
mods.gregtech.assembler.recipeBuilder()
    ...
    .duration(20000) 
    .EUt(7680) 
	.notConsumable(item('galaxyspace:schematics', 2))
    .buildAndRegister()
//
mods.gregtech.assembler.recipeBuilder()
    ...
    .duration(20000) 
    .EUt(7680) 
	.notConsumable(item('galaxyspace:schematics', 3))
    .buildAndRegister()
//
mods.gregtech.assembler.recipeBuilder()
...
//
mods.gregtech.assembler.recipeBuilder()
    .inputs(item('galaxyspace:hdp')*12,item('galaxyspace:rocket_modules', 8)*4,item('galacticraftcore:spin_thruster')*2,item('galacticraftcore:engine')*2,item('galacticraftcore:basic_item', 20),item('galacticraftcore:basic_item', 19),item('galacticraftcore:oxygen_concentrator'),item('galacticraftcore:basic_item', 14))
...
//
mods.gregtech.assembler.recipeBuilder()
    .inputs(item('galaxyspace:hdp', 1)*12,item('galaxyspace:rocket_modules', 13)*4,item('galacticraftcore:spin_thruster')*2,item('galacticraftcore:engine')*2,item('galacticraftcore:basic_item', 20),item('galacticraftcore:basic_item', 19),item('galacticraftcore:oxygen_concentrator'),item('galacticraftcore:basic_item', 14))
...
//
mods.gregtech.assembler.recipeBuilder()
    .inputs(item('galaxyspace:hdp',2)*12,item('galaxyspace:rocket_modules', 18)*4,item('galacticraftcore:spin_thruster')*2,item('galacticraftcore:engine')*2,item('galacticraftcore:basic_item', 20),item('galacticraftcore:basic_item', 19),item('galacticraftcore:oxygen_concentrator'),item('galacticraftcore:basic_item', 14))
